...
function fig3_constant
    resultname=fullfile('data','fig3_batch_result.mat');
    if ~exist(resultname,'file')
        filename=fullfile('data','fig3_batch_result_*'); 
        files=dir(filename);
    ...
    plot_correlation_map(all_r_alphaEnvHrfbp_simBOLDbp,As,rangeA,rangeB,rangeC,[-1 1]*.06,'fig3A_alpha.png')
    plot_correlation_map(all_r_gammaEnvHrfbp_simBOLDbp,As,rangeA,rangeB,rangeC,[-1 1]*.2,'fig3A_gamma.png')
    plot_histogram(all_r_alphaEnvHrfbp_simBOLDbp,all_r_gammaEnvHrfbp_simBOLDbp,...
                   As,rangeA,rangeB,rangeC,'fig3B.png'); 
end
%==========================================================================

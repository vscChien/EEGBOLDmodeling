% >> fig4(1); % plot Fig.4
% >> fig4(2); % plot Fig.S4 example 1
% >> fig4(3); % plot Fig.S5 example 2
% >> fig4(4); % plot Fig.S6 example 3
...
function fig4(fig)
    ...
    resultfilename=fullfile('data',...
        sprintf('fig4_result_randspeed%d_mv%d_lat%g%g_mod%g%g_tha%g%g.mat',speed,mvwindow/1e3,Ilat_range,Imod_range,Itha_range));
    ...
    plot_magri(mean(r_overall,2),mean(r_pertile,3),F,P,tiles,[figname 'C.png']);
    trialidx=1;plotOn=1;
    simulation(input(:,:,trialidx),duration,dt,Ilat_range,Imod_range,Itha_range,plotOn,inputTag(:,trialidx),[figname 'A.png']);
    plot_spect_stat(stat,figname);
...
%==========================================================================
function plot_spect_stat(stat,figname) 
    alphaz=[];
    gammaz=[];
    LFPpowerz=[];
    PLabel=[];
    ...
    saveas(gcf,fullfile('figures',[figname 'D.png']));
    ...
    height=10;
    set(gcf,'units','centimeters','position',[2 2 width height])
    saveas(gcf,fullfile('figures',[figname 'E.png']));
    ...
    height=7;
    set(gcf,'units','centimeters','position',[2 2 width height])
    saveas(gcf,fullfile('figures',[figname 'B.png']));

...
function figS2()
    ...
    plot_figS2ac(all_BOLD,rangeA,rangeB,rangeC,As,k,tag);
    plot_figS2b(all_spect,freq,all_BOLD,rangeA,As,k,tag,frange);
    plot_figS2d(all_spect,freq,all_BOLD,rangeA,As,k,tag,frange);
...
%==========================================================================
function plot_figS2ac(all_BOLD,rangeA,rangeB,rangeC,As,k,tag)
    ...
    saveas(gcf,fullfile('figures','figS2AC.png')); 
end

%==========================================================================
function plot_figS2b(all_spect,freq,all_BOLD,rangeA,As,k,tag,frange)
    ...
    height=10;
    set(gcf,'units','centimeters','position',[2 2 width height])
    saveas(gcf,fullfile('figures','figS2B.png')); 
end

%==========================================================================
function plot_figS2d(all_spect,freq,all_BOLD,rangeA,As,k,tag,frange)
    ...
    height=10;
    set(gcf,'units','centimeters','position',[2 2 width height])
    saveas(gcf,fullfile('figures','figS2D.png')); 
end

...
function fig3_varying()
    ...
    % check saved result
    noiseLevel=1;
    resultfilename=fullfile('data',sprintf('fig3_result_10min_noise=%g.mat',noiseLevel));    
    ...
    plot_histogram(cond, all_r_alphaEnvHrfbp_simBOLDbp,all_r_gammaEnvHrfbp_simBOLDbp,'fig3D.png');

    plotOn=1; rmbase=1;
    for i=1:3
        simulation(input(:,:,1),duration,dt,noiseLevel,cond(i).Ilat_range,cond(i).Imod_range,cond(i).Itha_range,plotOn,rmbase,sprintf('fig3E_%d.png',i));
    end
